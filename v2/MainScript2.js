...
function createTimeline() {
    ...
    //console.log("Commented out ajax setup for debug purposes");
    ///*
    $.ajaxSetup({
        headers: {
...
function updateOverview(){
    if(DEBUG){
        var vacLevel = (Math.random()*1).toFixed(2);
        var cryoT = (23+Math.random()*1).toFixed(1);
        var avgT = (27+Math.random()*1).toFixed(1);
        var magVoltage = (0.1*Math.random()).toFixed(1);
        var mpsuVoltage = 0.1;
        var hePressureLow = (12+Math.random()).toFixed(0);
        var hePressureHigh = (15+Math.random()).toFixed(0);
        var water = (0+Math.random()*0.1).toFixed(1);
        document.getElementById('vacLevel').innerHTML = vacLevel+" mbar";
        document.getElementById('cryoT').innerHTML = cryoT+" K";
        document.getElementById('avgT').innerHTML = avgT+" K";
        document.getElementById('vacLimit').innerHTML ="0.01 mbar";
        document.getElementById('cryoTLimit').innerHTML = "25 K";
        document.getElementById('magVoltage').innerHTML = magVoltage+" V";

        document.getElementById('mpsuState').innerHTML = " ON";
        document.getElementById('cryoState').innerHTML = " ON";
        document.getElementById('turboState').innerHTML = " ON";
        document.getElementById('mpsuCurrent').innerHTML ="1000 A";
        document.getElementById('mpsuVoltage').innerHTML = mpsuVoltage+" V";

        document.getElementById('hePressureLow').innerHTML = hePressureLow+" mbar";
        document.getElementById('hePressureHi').innerHTML = hePressureHigh+" mbar";
        document.getElementById('water').innerHTML = water+" L/s";
        document.getElementById('cryoHours').innerHTML ="20 hrs";
        document.getElementById('turboHours').innerHTML = "25 hrs";
